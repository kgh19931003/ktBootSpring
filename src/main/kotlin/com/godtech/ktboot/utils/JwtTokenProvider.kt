package com.godtech.ktboot.utils


import com.godtech.ktboot.orm.jpa.MemberRepository
import com.godtech.ktboot.proto.removeBearerPrefix
import com.godtech.ktboot.service.TokenValidationService
...
class JwtTokenProvider(
    ...
    // 리프레시 토큰 유효시간 60분
    private val refreshTokenValidTime = 240 * 60 * 1000L
    ...
    private fun handleExpiredRefreshToken(memId: String) {
        memberRepository.deleteAccessTokenById(memId)
        memberRepository.deleteRefreshTokenById(memId)
    }
}